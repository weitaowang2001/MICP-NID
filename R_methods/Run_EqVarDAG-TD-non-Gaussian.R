###############################################
# Run EqVarDAG-TD on all NID datasets with non-Gaussian errors
###############################################
...
write.csv(results, "./experiment results/comparison to other benchmarks with non-Gaussian errors/1-30/EqVarDAG-TD_results-non-Gaussian.csv",row.names=FALSE)
