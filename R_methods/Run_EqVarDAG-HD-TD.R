###############################################
# Run EqVarDAG-HD-TD on all NID datasets
###############################################
...
source("E:/Northwestern/Research/independent study 1/dag/gurobi/R_methods/EqVarDAG_HD_TD.R")
...
write.csv(results, "EqVarDAG-HD-TD_results.csv",row.names=FALSE)
