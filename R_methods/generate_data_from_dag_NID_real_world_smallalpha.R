##############
### 03/18/2025 
### Generate 30 datasets for each real world network from 1dsep to 12hepar
### sigvec change from c(0.5, 1, 1.5) to c(0.8, 1, 1.2)
##############
library(igraph)
library(MASS)

data.path = "~/Downloads/projects/micodag/Data/RealWorldDatasetsTXu_smallalpha/"
setwd(data.path)
