###############################################
# Run EqVarDAG-HD-BU on all synthetic non-Gaussian NID datasets
###############################################
...
write.csv(results, "./experiment results/comparison with synthetic non-Gaussian errors/1-30/EqVarDAG-HD-BU_synthetic_non-Gaussian_results.csv",row.names=FALSE)
