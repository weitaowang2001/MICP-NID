###############################################
# Run EqVarDAG-TD on all synthetic non-Gaussian NID datasets
###############################################
...
write.csv(results, "./experiment results/comparison with synthetic non-Gaussian errors/1-30/EqVarDAG-TD_synthetic_non-Gaussian_results.csv",row.names=FALSE)
