###############################################
# Run GES algorithm on all synthetic NID datasets, with true moral graph
###############################################
...
write.csv(results, "./experiment results/comparison with synthetic non-Gaussian errors/1-30/ges_synthetic_non-Gaussian_results.csv",row.names=FALSE)
