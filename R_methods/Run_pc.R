###############################################
# Run pc algorithm on all NID datasets
###############################################
...
dataset.folder <- "/Users/tongxu/Downloads/projects/micodag/Data/RealWorldDatasetsTXu/"
...
write.csv(results, "pc_results.csv",row.names=FALSE)
